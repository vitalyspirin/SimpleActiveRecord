 ...
 * @property string $col_enum3
 * @property string $col_enum4
 * @property string $col_set1
 * @property string $col_set2
 * @property string $col_set3
 * @property string $col_set4
 * @property string $col_date1
 * @property string $col_date2
 * @property string $col_datetime1
 * @property string $col_datetime2
 * @property string $col_datetime3
 * @property string $col_datetime4
...
class T1YiiModel extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['col_varchar2', 'col_varchar4', 'col_varbinary2', 'col_varbinary4'], 'string', 'max' => 3],
            [['col_int1'], 'unique'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'col_doubleprecision5' => 'Col Doubleprecision5',
            'col_char1' => 'Col Char1',
            'col_char2' => 'Col Char2',
            'col_char3' => 'Col Char3',
            'col_char4' => 'Col Char4',
            ...
            'col_varchar3' => 'Col Varchar3',
            'col_varchar4' => 'Col Varchar4',
            'col_binary1' => 'Col Binary1',
            'col_binary2' => 'Col Binary2',
            'col_binary3' => 'Col Binary3',
            'col_binary4' => 'Col Binary4',
            'col_binary5' => 'Col Binary5',
            'col_binary6' => 'Col Binary6',
            'col_varbinary1' => 'Col Varbinary1',
            'col_varbinary2' => 'Col Varbinary2',
            'col_varbinary3' => 'Col Varbinary3',
            'col_varbinary4' => 'Col Varbinary4',
            ...
            'col_datetime3' => 'Col Datetime3',
            'col_datetime4' => 'Col Datetime4',
    ...
    {
        return $this->hasOne(T2::className(), ['col_id' => 'col_id']);
    }
}
